...
@with_kw struct WH_noise_B2 <: NestedIBVP
...
BondiToy.ψv0_of_uz(u::T, z::T, ibvp::WH_noise_B2) where {T<:Real} =
    ibvp.noise_amplitude * randn(T)

BondiToy.ψ0_of_Xz(X::T, z::T, ibvp::WH_noise_B2) where {T<:Real} =
    ibvp.noise_amplitude * randn(T)


toy_model = "WH_noise_B2_norms"
root_dir="./run00"
